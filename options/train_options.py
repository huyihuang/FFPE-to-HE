...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_cs', type=float, default=10.0, help='weight for L1_loss')              
        ...
        self.parser.add_argument('--no_cp_loss', action='store_true', help='if specified, do *not* use cellpose loss')
        self.parser.add_argument('--netD_cat', type=int, default=1, help='if <0 cat input, if 0 cat none, if [1,2,3], use cpout[:,2: or 0:2 or :,:,:] for netD_input')
